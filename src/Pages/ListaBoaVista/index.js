    ...
    const listRef = firebase.firestore().collection('boavista').orderBy('created', 'desc');
    
    export default function ListaBoaVista(){
    ...
    {chamados.length === 0 ? (
              <div className="container dashboard">
                ...
                <Link to="/newboavista" className="new">
              ...
              {chamados.map((item, index)=>{
                  ...
                  <td data-label="Editar/Deletar">
                    <Link className="action" style={{backgroundColor: '#3583f6' }}to={`/newboavista/${item.id}`}>
