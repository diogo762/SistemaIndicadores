    ...
    import './indicadorIncorporacao.css';
    ...
    const listRef = firebase.firestore().collection('indicadorincorporacao').orderBy('created', 'desc');
  
    
    export default function IndicadorIncorporacao(){
      ...
      async function excluirPost(id){
        ...
        await firebase.firestore().collection('indicadorincorporacao').doc(id)
        .delete()
        .then(()=>{
    ...
    {chamados.length === 0 ? (
              <div className="container dashboard">
                ...
                <Link to="/newindicadorincorporacao" className="new">
              ...
              {chamados.map((item, index)=>{
                  ...
                  <td data-label="Cenário">{item.Cenário}</td>
                  ...
                  <td data-label="Editar/Deletar">
                    <Link className="action" style={{backgroundColor: '#3583f6' }}to={`/newindicadorincorporacao/${item.id}`}>
