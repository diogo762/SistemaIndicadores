import './newIndicadorIncorporacao.css';
...
export default function NewIndicadorIncorporacao(){
    ...
    useEffect(()=> {
      async function loaders(){
        await firebase.firestore().collection('indicadorincorporacao')
        .get()
        .then((snapshot)=>{
          let lista = [];
    ...
    async function handleRegister(e){
        ...
        if(id){
          ...
          .then(()=>{
            ...
            history.push('/indicadorincorporacao');
          })
          .catch((err)=>{
    ...
    <div className="container">
      ...
      <select  value={cenario} onChange={handleChangeCen} required> 
       ...
       <option value="1">1</option>
        ...
        <Link to="/indicadorincorporacao" className ="new">
      Voltar para a lista
      </Link>
